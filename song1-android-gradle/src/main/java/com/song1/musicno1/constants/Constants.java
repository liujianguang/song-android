package com.song1.musicno1.constants;
...
public interface Constants {
  public static final Integer[] DEVICE_IOC_NORMAL   =
      {
          ...
          R.drawable.corridor_ic_butoon_nor, R.drawable.diningroom_ic_butoon_nor, R.drawable.familyactivities_ic_butoon_nor,
          R.drawable.garage_ic_butoon_nor, R.drawable.garden_ic_butoon_nor, R.drawable.guestroom_ic_butoon_nor,
          R.drawable.gym_ic_butoon_nor, R.drawable.hall_ic_butoon_nor, R.drawable.kitchen_ic_butoon_nor,
          R.drawable.livingroom_ic_butoon_nor, R.drawable.mastebedroom_ic_butoon_nor, R.drawable.multimediaroom_ic_butoon_nor,
  ...
  public static final Integer[] DEVICE_IOC_SELECTED =
      {
          R.drawable.bathroom_ic_butoon_press, R.drawable.bedroom_ic_butoon_press,
          R.drawable.corridor_ic_butoon_press, R.drawable.diningroom_ic_butoon_press, R.drawable.familyactivities_ic_butoon_press,
          R.drawable.garage_ic_butoon_press, R.drawable.garden_ic_butoon_press, R.drawable.guestroom_ic_butoon_press,
          R.drawable.gym_ic_butoon_press, R.drawable.hall_ic_butoon_press, R.drawable.kitchen_ic_butoon_press,
          R.drawable.livingroom_ic_butoon_press, R.drawable.mastebedroom_ic_butoon_press, R.drawable.multimediaroom_ic_butoon_press,
