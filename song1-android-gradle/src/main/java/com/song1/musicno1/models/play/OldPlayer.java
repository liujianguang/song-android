...
public class OldPlayer {
  ...
  public OldPlayer(Context context, Renderer renderer, RenderingControl renderingControl) {
  ...
  public interface OnStateChangedListener {
    void onStateChanged(OldPlayer player, int state);
  }

  public interface OnPositionChangedListener {
    void onPositionChanged(OldPlayer player, long position, long duration);
  }

  public interface OnCompleteListener {
    void onComplete(OldPlayer player);
  }

  public interface OnOccupiedListener {
    void onOccupied(OldPlayer player);
  }
